export default {
  ...
  'pages.form.basicForm.title': '基础表单',
  'pages.form.stepForm.title': '分步表单',
  'pages.form.advanceForm.title': '高级表单',
  ...
  'pages.profile.advanceProfile.title': '高级详情页',
  ...
  'pages.system.roleList.title': '角色管理',
  'pages.system.permissionList.title': '权限管理',
