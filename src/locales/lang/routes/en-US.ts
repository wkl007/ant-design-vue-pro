export default {
  ...
  'pages.workplace.title': 'Workplace',
  ...
  'pages.form.basicForm.title': 'Basic Form',
  'pages.form.stepForm.title': 'Step Form',
  'pages.form.advanceForm.title': 'Advance Form',
  ...
  'pages.system.roleList.title': 'Role List',
  'pages.system.permissionList.title': 'Permission List',
